  ...
  return (
    <article className="flex flex-col gap-10 text-typography-sm leading-loose">
        ...
        <ol className="flex flex-col gap-5 pl-5 [&>li]:list-decimal [&>li]:marker:font-bold">
          ...
          <li>
            <p>
              ...
              管理者は、本サービスの利用または利用不能に起因してユーザーに生じたあらゆる損害について、管理者の故意または重過失による場合を除き、一切の責任を負いません。
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              管理者は、ユーザーへの事前の通知なく、本サービスの内容を変更、追加し、または提供を中止することがあります。管理者は、これによりユーザーに生じた損害について、管理者の故意または重過失による場合を除き、一切の責任を負いません。
            </p>
          </li>
        </ol>
      </section>
      ...
      <section className="flex flex-col gap-1">
        ...
        <p>
          本規約の成立、効力、履行および解釈には日本法が適用されます。本サービスに関連して管理者とユーザーとの間で生じた紛争については、日本国の裁判所を管轄裁判所とし、その中でも管理者所在地を管轄する裁判所を第一審の専属的合意管轄とします。
        </p>
      </section>
      <section className="flex flex-col gap-1">
        <p>制定：2025年3月</p>
