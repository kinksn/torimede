...
export const PrivacyText = () => {
  return (
    <article className="flex flex-col gap-10 text-typography-sm leading-loose">
      <p>
        トリメデ（以下「本サービス」）におけるユーザーの個人情報および関連データの取り扱いについて、本プライバシーポリシーに従います。管理者（本サービスの運営者）は、ユーザーのプライバシーを尊重し、個人情報の適切な保護と管理に努めます。
      </p>
        ...
        <ul className="flex flex-col gap-5 mt-5 [&>li]:before:content-[' '] [&>li]:before:min-w-1 [&>li]:before:min-h-1 [&>li]:before:block [&>li]:before:bg-textColor-basic [&>li]:before:rounded-full [&>li]:before:my-3 [&>li]:before:mx-[10px]">
          ...
          <li className="flex items-start">
            <p>
              ...
              ユーザーの個人情報は、管理者が管理する安全なサーバー環境（クラウドサービス上のデータベース等）に保存されます。管理者は、収集した情報をサービス提供に必要な期間保管します。ユーザーがアカウントの削除を希望する場合や、保管する必要がなくなった情報については、遅滞なく消去または匿名化するよう努めます。
            </p>
          </li>
          <li className="flex items-start">
            <p>
